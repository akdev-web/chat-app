...
const Verify = () => {
  ...
  const renderRedirectMessage = (msg) => (
    <div className="mx-auto bg-linear-[0deg,#d7dde4,transparent_50%] dark:bg-linear-[0deg,black,#2d2c2c] text-[var(---color-text)] w-full sm:w-[400px] p-4  mx-autu sm:rounded-2xl"
  ...
  return (
    <div className="bg-linear-[0deg,#d7dde4,transparent_50%] dark:bg-linear-[0deg,black,#2d2c2c] text-[var(---color-text)] w-full sm:w-[400px] p-4  mx-auto sm:rounded-2xl">
