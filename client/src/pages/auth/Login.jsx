...
const Login = () => {
  ...
  return (
    <div className='w-full sm:w-[400px]  px-4 py-10 mx-auto  bg-linear-[0deg,#d7dde4,transparent_50%] dark:bg-linear-[0deg,black,#2d2c2c] text-[var(---color-text)]  sm:rounded-2xl 
       ' style={{boxShadow: '0 4px 8px 2px  var(---color-shadow)'}}>
      <form className='flex flex-col items-center justify-center gap-3 ' onSubmit={handleForm}>
