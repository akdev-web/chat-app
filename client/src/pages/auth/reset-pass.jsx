...
const Reset = () => {
  ...
  return (
    <div className="bg-linear-[0deg,#d7dde4,transparent_50%] dark:bg-linear-[0deg,black,#2d2c2c] text-[var(---color-text)] w-full sm:w-[400px] px-4 py-10 mx-auto sm:rounded-2xl"
