...
const AuthLayout = () => {
  ...
  if(user) return <Navigate to='/user' replace={true} state={{alert:{msg:'logged in successfully',type:'success'}}} />

  return (
    <div className='w-full min-h-screen pt-[150px]  h-full bg-[var(---color-body-bg)]'>
        <Navbar />
        <Outlet />
    </div>
  )
